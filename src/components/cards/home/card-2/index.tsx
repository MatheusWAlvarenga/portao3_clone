  ...
  return (
    <div className='flex flex-col justify-center items-center bg-base gap-10 py-10 sm:py-20 lg:py-28 w-full '>
      ...
      <div
        ...
        className={`${
          viewFlag ? '' : 'opacity-0'
        } transition-opacity duration-1000  w-full flex flex-col gap-4  justify-center items-center mt-10 tablet:w-[95%] tablet:grid tablet:grid-cols-2 tablet:mt-16 lg:w-[98%] lg:grid-cols-3 lg:mt-20 desktop:flex  desktop:flex-row`}
      >
        {itemList.map((flag) => {
