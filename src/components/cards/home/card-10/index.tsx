...
export function CardHome_10() {
  ...
  return (
    <div
      ...
      className={`${
        viewDiv ? '' : 'opacity-0'
      } transition-opacity duration-1000  flex w-full justify-center items-center py-20 px-[2%] sm:px-[4%] md:px-[8%] tablet:px-[10%] lg:px-[12%] desktop:px-[15%] monitor:px-[22%]  font-montserrat text-white`}
    >
      <div
