    ...
    <div className='flex flex-col justify-center items-center bg-base gap-10 py-10 sm:py-20 lg:py-28 w-full '>
      ...
      <div className='w-full flex justify-center items-center mt-10 md:mt-20 '>
        <div
          ...
          className={`${
            viewFlag ? '' : 'opacity-0'
          } transition-opacity duration-1000 delay-300 w-[80%] sm:w-[75%] md:w-[70%] tablet:w-[60%] lg:w-[70%] desktop:[65%] monitor:w-[55%] flex flex-col lg:flex-row justify-between items-center`}
        >
          {itemsList.map((card) => {
