...
export function Flag({ props }: FlagProps) {
  ...
  return (
    <main className='flex  w-[95%] md:w-[90%] tablet:w-[85%] lg:w-[33%] flex-col justify-center items-start gap-4 lg:gap-8 p-4 mb-8 '>
      <div
        className={`flex justify-center items-center w-full bg-flag_bg rounded-lg p-2 hover:-translate-y-2 drop-shadow-lg mb-4 lg:mb-0 ${
      ...
      <div
        ...
        className={`flex gap-1 w-full px-8 py-6 font-montserrat border-2 border-white drop-shadow-2xl rounded-lg ${
